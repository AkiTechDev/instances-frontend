import { children, createSignal, onCleanup, type JSXElement } from "solid-js";
import styles from "./Test.module.css";
import { Show } from "solid-js";

const Tooltip = (props: { tooltipContent: string, tooltipContentStyle: CSSModuleClasses[string], enableTimeout: boolean, timeoutDuration: number, children: JSXElement }) => {
